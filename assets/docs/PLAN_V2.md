...
```text
chore: formalize v1 and create development branch
chore: prepare v2 base structure
chore: add local phosphor icons
feat: implement responsive v2 interface
feat: add dynamic content from json
feat: add tabs, theme, and link sharing
perf: optimize performance and accessibility
docs: update v2 documentation and roadmap
```
